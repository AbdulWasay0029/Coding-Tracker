                ...
                {isLoggedIn ? (
                    <div className="relative">
                        ...
                        >
                            ...
                            <optgroup label="Your CodeSync Servers">
                                {guilds.map(g => (
                    ...
                    <button 
                        ...
                        className="text-xs font-medium bg-surface border border-border text-text-secondary px-3 py-1.5 rounded-lg hover:text-white transition-colors"
                    >
                        Login to view Server Leaderboards
                    </button>
                )}

                <div className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-primary/10 border border-primary/20 text-xs font-medium text-primary">
