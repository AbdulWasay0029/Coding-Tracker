        ...
        <main className="min-h-screen flex flex-col bg-background text-foreground overflow-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center max-w-5xl mx-auto pt-20 pb-16 relative">
                ...
                <div className="space-y-8 relative z-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-border bg-surface text-xs font-mono text-primary mb-4 shadow-[0_0_10px_rgba(0,240,255,0.1)]">
                    ...
                    <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-6">
                        <Link 
                            ...
                            className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-[#0B0E14] bg-primary rounded hover:bg-transparent hover:text-primary border-2 border-primary transition-all shadow-[0_0_20px_rgba(0,240,255,0.4)] hover:shadow-[0_0_30px_rgba(0,240,255,0.6)]"
                        >
                        ...
                        <Link 
                            href="/leaderboard" 
                            className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-text-primary bg-surface rounded hover:bg-border border-2 border-border transition-colors"
                        >
                            View Leaderboard
                        </Link>
                    </div>
            ...
            {/* Terminal Mockup */}
            <div className="max-w-4xl mx-auto w-full px-4 relative z-10 -mt-8 mb-24">
            ...
            <div className="bg-surface border-t border-border py-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="classic-card p-8 hover:border-primary transition-colors">
                        ...
                        <div className="classic-card p-8 hover:border-secondary transition-colors">
